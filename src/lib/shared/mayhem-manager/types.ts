...
export type MayhemManagerGameStage =
	| 'preseason'
	| 'draft'
	| 'free agency'
	| 'training'
...
export type MayhemManagerViewpoint =
	| PreseasonViewpoint
	| DraftViewpoint
	| FAViewpoint
	| TrainingViewpoint
...
export type MayhemManagerExport =
	| PreseasonExport
	| DraftExport
	| FAExport
	| TrainingExport
...
interface ChangeRoomSettingsAction {
	type: 'changeRoomSettings';
	roomName: string;
	isPublic: boolean;
}

export type MayhemManagerAction =
	| ChangeRoomSettingsAction
	| JoinAction
	| LeaveAction
	| ReplaceAction
	| RemoveAction
...
export type MayhemManagerEvent =
	| RoomEvent
	| ChangeHostEvent
	| JoinEvent
	| LeaveEvent
