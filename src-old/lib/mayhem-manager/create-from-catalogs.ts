...
import { type Appearance, type Color, type Equipment, type EquipmentInBattle, type Fighter, type FighterNames, type FighterStats } from "$lib/mayhem-manager/types";
import type { RNG } from "$lib/types";
import { equipmentCatalog } from "./equipment-catalog";
import { fighterAbilitiesCatalog } from "./fighter-ability-catalog";
